...
export default function ProviderRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!fullName || !email || !phone || !password || !confirmPassword || !businessName) {
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md lg:max-w-lg">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <h3 className="text-md font-bold text-gray-800 border-b border-gray-100 pb-2">
            ...
            <h3 className="text-md font-bold text-gray-800 border-b border-gray-100 pb-2 pt-4">
              Business Profile Details
            </h3>

            <div>
              <label htmlFor="businessName" className="block text-sm font-semibold text-gray-700">
                {t('business_name', { ns: 'provider' })} *
              </label>
              <div className="mt-1">
                <input
                  id="businessName"
                  type="text"
                  required
                  placeholder="e.g., Annapurna Tiffin Services"
                  value={businessName}
            ...
            <div>
              <label htmlFor="businessDescription" className="block text-sm font-semibold text-gray-700">
                {t('business_description', { ns: 'provider' })}
              </label>
              <div className="mt-1">
                <textarea
                  id="businessDescription"
                  rows="3"
                  placeholder="Tell customers about your service quality, ingredients, timings, etc."
