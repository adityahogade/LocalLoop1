...
export default function Landing() {
  ...
  return (
    <div className="space-y-16 pb-12">
      {/* 1. HERO SECTION */}
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-850 to-blue-950 text-white rounded-3xl py-12 md:py-20 px-6 md:px-12 shadow-2xl overflow-hidden text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            <p className="text-sm md:text-base text-slate-400 font-semibold leading-relaxed max-w-xl">
            ...
            <form onSubmit={handleSearchSubmit} className="bg-white p-2 rounded-2xl md:rounded-full shadow-lg flex flex-col md:flex-row gap-2 max-w-2xl text-slate-800">
              <div className="flex-1 flex items-center px-3 border-b md:border-b-0 md:border-r border-slate-100 py-1">
                ...
                <input
                  ...
                  className="w-full text-xs font-semibold focus:outline-none placeholder-slate-400 text-slate-800"
                />
              </div>
              <div className="flex items-center gap-2 px-3 py-1">
                ...
                <input
                  ...
                  className="w-24 text-xs font-semibold focus:outline-none placeholder-slate-400 text-slate-800"
                />
                <button
                  type="button"
                  onClick={handleGPSDetect}
                  disabled={detecting}
                  className="text-blue-600 hover:text-blue-700 p-1.5 rounded-lg hover:bg-slate-50 transition-colors"
              ...
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-700 text-white font-black text-xs uppercase tracking-wider px-6 py-3 rounded-xl md:rounded-full transition-all active:scale-[0.98]"
              >
                Search
              </button>
            </form>
      ...
      {location && (
        <section className="bg-white border border-slate-200 rounded-3xl p-5 shadow-sm text-left flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <button
            ...
            className="text-xs font-black text-blue-600 hover:text-blue-700 uppercase tracking-widest flex items-center gap-1 active:translate-x-0.5 transition-transform"
          >
      ...
      <section className="space-y-6 text-left">
        <div className="flex justify-between items-end border-b border-slate-100 pb-4">
          ...
          <Link
            to="/catalog"
            className="text-xs font-black text-blue-600 hover:text-blue-700 uppercase tracking-wider hidden sm:block"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {coreCategoriesList.map((cat) => (
            <button
              ...
              className={`flex flex-col p-6 border rounded-2xl shadow-sm text-left transition-all duration-300 hover:shadow-md hover:-translate-y-1 cursor-pointer ${cat.bg}`}
            >
      ...
      <section className="space-y-6 text-left">
        ...
        {loadingFeatured ? (
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 text-center text-xs text-slate-500 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredServices.map((svc) => {
              ...
              return (
                <div
                  key={svc.id}
                  className="bg-white border border-slate-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col text-left group"
                >
                  ...
                  <div className="p-5 flex-grow flex flex-col space-y-3">
                    ...
                    <div className="pt-2 flex justify-between items-center mt-auto">
                      ...
                      <button
                        ...
                        className="bg-slate-900 hover:bg-slate-800 text-white text-[10px] font-black uppercase tracking-widest px-4 py-2.5 rounded-xl transition-all active:scale-[0.98] cursor-pointer"
                      >
                        Book Now
                      </button>
                    </div>
      ...
      {/* 5. HOW IT WORKS */}
      <section className="bg-slate-900 text-white rounded-3xl p-8 md:p-12 shadow-xl text-left space-y-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
          {[
            ...
            <div key={idx} className="bg-slate-850/50 border border-slate-800 rounded-2xl p-6 space-y-4">
      ...
      <section className="bg-amber-50/50 border border-amber-200 rounded-3xl p-6 text-left flex items-start gap-3">
